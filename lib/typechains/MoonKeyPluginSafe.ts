...
export interface MoonKeyPluginSafeInterface extends utils.Interface {
	functions: {
...
export interface MoonKeyPluginSafe extends BaseContract {
	connect(signerOrProvider: Signer | Provider | string): this;
	attach(addressOrName: string): this;
	deployed(): Promise<this>;

	interface: MoonKeyPluginSafeInterface;
